...
### Martín Pérez (HOME, LHP, 35 📉📉 明顯退化)
- **Tier 驗證**：腳本 tier_v2 = 🟠 Strong Ace（xFIP p87, K-BB% p78），gap vs ERA-only = -1.7
...
- **Tier 驗證**：腳本 tier_v2 = 🔴 Elite Ace（xFIP p89, K-BB% p78），gap vs ERA-only = +26.7
  - <!-- AI 補：是否同意 score-derived tier？若 |gap| ≥ 15 → 簡述運氣 vs 結構性，不自動下修預測 -->
- **Reverse platoon 信號**：見 dossier `## 🎯 訊號摘要`（若 fired）
  - <!-- AI 補：若 fired，本場對手核心打者手別組成是否放大此風險？ -->
- **對手打線威脅**：<!-- AI 補：基於 dossier 投手對決表 + 上述兩信號 -->
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 3.08 / 6 / <!-- AI --> | 4.79 / 6 / <!-- AI --> |
...
### 額外信號
- 🟠 HOME TTO3 penalty：OPS Δ +0.141（TTO1 0.669 → TTO3 0.810），第三輪明顯衰退；K% 從 20.8% 掉到 15.5%（Δ -5.3pp）（career fallback）
- 🟠 HOME chain breaks at #8-9：OPS 落差 0.192
- 🔴 AWAY chain breaks at #3-4：OPS 落差 0.435
...
| HOME | 4.9 | <!-- AI 補 --> | <!-- AI 補 --> |
| AWAY | 4.2 | <!-- AI 補 --> | <!-- AI 補 --> |
| Total | 9.100000000000001 | <!-- AI 補 --> | <!-- AI 補 --> |
