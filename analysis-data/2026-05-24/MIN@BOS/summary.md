...
- **Tier 驗證**：腳本 tier_v2 = 🟠 Strong Ace（xFIP p85, K-BB% p67），gap vs ERA-only = -5.0
...
### Bailey Ober (AWAY, RHP, 30 📉 初期退化)
- **Tier 驗證**：腳本 tier_v2 = 🟡 Solid Starter（xFIP p34, K-BB% p49），gap vs ERA-only = -15.2
  - <!-- AI 補：是否同意 score-derived tier？若 |gap| ≥ 15 → 簡述運氣 vs 結構性，不自動下修預測 -->
- **Reverse platoon 信號**：見 dossier `## 🎯 訊號摘要`（若 fired）
  - <!-- AI 補：若 fired，本場對手核心打者手別組成是否放大此風險？ -->
- **對手打線威脅**：<!-- AI 補：基於 dossier 投手對決表 + 上述兩信號 -->
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 3.0 / 5 / <!-- AI --> | 4.8 / 6 / <!-- AI --> |
...
### 額外信號
- 🟠 HOME reverse platoon Δ +0.165（vs RHB OPS 0.763 > vs LHB OPS 0.598）— RHP 對非預期手別反而吃虧
- ℹ️ HOME balanced 4+ pitches：最高球種僅 22.8%（<25.0%）
- 🔴 AWAY TTO3 penalty：OPS Δ +0.409（TTO1 0.440 → TTO3 0.849），第三輪明顯衰退
- 🟠 HOME chain breaks at #4-5：OPS 落差 0.201
- 🔴 AWAY chain breaks at #7-8：OPS 落差 0.463
...
- 天氣：Overcast, 52°F, wind 10 mph, In From RF
