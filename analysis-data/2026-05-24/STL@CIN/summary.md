...
- **Tier 驗證**：腳本 tier_v2 = 🟡 Solid Starter（xFIP p59, K-BB% p50），gap vs ERA-only = +48.3
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 5.04 / 4 / <!-- AI --> | 4.39 / 0 / <!-- AI --> |
...
### 額外信號
- 🟠 HOME single-pitch dependent：主球種使用率 46.8%（≥45.0%）
- 🔴 HOME chain breaks at #7-8：OPS 落差 0.382
...
- 天氣：Drizzle, 68°F, wind 3 mph, Out To LF
