...
- **Tier 驗證**：腳本 tier_v2 = 🟡 Solid Starter（xFIP p58, K-BB% p61），gap vs ERA-only = +48.9
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 4.0 / 3 / <!-- AI --> | 3.71 / 0 / <!-- AI --> |
...
### 額外信號
- 🔴 HOME reverse platoon Δ +0.259（vs RHB OPS 0.959 > vs LHB OPS 0.700）— RHP 對非預期手別反而吃虧
- 🔴 AWAY TTO3 penalty：OPS Δ +0.233（TTO1 0.487 → TTO3 0.720），第三輪明顯衰退
- 🟠 HOME chain breaks at #3-4：OPS 落差 0.271
- 🟠 AWAY chain breaks at #6-7：OPS 落差 0.189
  - <!-- AI 補：本場是否受此信號影響？是否與 Flag 3/8 雙重壓力 → 1-2 句敘事 -->

## 條件修正

- Park Factor: 104.0 → +0.20 run
- 天氣：Cloudy, 61°F, wind 7 mph, In From RF
