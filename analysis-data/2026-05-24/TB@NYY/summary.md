...
- **Tier 驗證**：腳本 tier_v2 = 🔴 Elite Ace（xFIP p95, K-BB% p95），gap vs ERA-only = +28.7
...
### Drew Rasmussen (AWAY, RHP, 30 📉 初期退化)
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 3.55 / 3 / <!-- AI --> | 4.31 / 6 / <!-- AI --> |
...
### 額外信號
- 🔴 HOME TTO3 penalty：OPS Δ +0.422（TTO1 0.638 → TTO3 1.060），第三輪明顯衰退；K% 從 25.0% 掉到 17.9%（Δ -7.1pp）
- 🟠 HOME chain breaks at #5-6：OPS 落差 0.176
- 🟠 AWAY chain breaks at #8-9：OPS 落差 0.218
...
- 天氣：Overcast, 56°F, wind 11 mph, In From CF
