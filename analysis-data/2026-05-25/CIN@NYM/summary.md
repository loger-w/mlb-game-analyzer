...
### Nolan McLean (HOME, RHP, 24 📈 成長期)
- **Tier 驗證**：腳本 tier_v2 = 🔴 Elite Ace（xFIP p95, K-BB% p95），gap vs ERA-only = +28.5
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 3.46 / 7 / <!-- AI --> | 5.04 / 4 / <!-- AI --> |
...
### 額外信號
- 🔴 HOME TTO3 penalty：OPS Δ +0.256（TTO1 0.493 → TTO3 0.749），第三輪明顯衰退
- 🟠 AWAY TTO3 penalty：OPS Δ +0.012（TTO1 0.661 → TTO3 0.673），第三輪明顯衰退；K% 從 31.0% 掉到 19.7%（Δ -11.3pp）（career fallback）
- 🔴 HOME chain breaks at #6-7：OPS 落差 0.409
- 🟠 AWAY chain breaks at #4-5：OPS 落差 0.274
