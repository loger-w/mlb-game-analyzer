...
- **Tier 驗證**：腳本 tier_v2 = 🟠 Strong Ace（xFIP p69, K-BB% p74），gap vs ERA-only = -14.0
...
- **Tier 驗證**：腳本 tier_v2 = 🔴 Elite Ace（xFIP p95, K-BB% p95），gap vs ERA-only = +29.3
  - <!-- AI 補：是否同意 score-derived tier？若 |gap| ≥ 15 → 簡述運氣 vs 結構性，不自動下修預測 -->
- **Reverse platoon 信號**：見 dossier `## 🎯 訊號摘要`（若 fired）
  - <!-- AI 補：若 fired，本場對手核心打者手別組成是否放大此風險？ -->
- **對手打線威脅**：<!-- AI 補：基於 dossier 投手對決表 + 上述兩信號 -->
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 4.62 / 6 / <!-- AI --> | 3.51 / 3 / <!-- AI --> |
...
### 額外信號
- 🔴 HOME reverse platoon Δ +0.241（vs RHB OPS 0.772 > vs LHB OPS 0.531）— RHP 對非預期手別反而吃虧
- 🟠 HOME TTO3 penalty：OPS Δ +0.043（TTO1 0.490 → TTO3 0.533），第三輪明顯衰退；K% 從 25.7% 掉到 18.6%（Δ -7.1pp）
- 🔴 AWAY TTO3 penalty：OPS Δ +0.300（TTO1 0.510 → TTO3 0.810），第三輪明顯衰退；K% 從 37.4% 掉到 17.1%（Δ -20.3pp）
- 🟠 HOME chain breaks at #2-3：OPS 落差 0.220
- 🟠 AWAY chain breaks at #7-8：OPS 落差 0.235
...
- 天氣：Sunny, 83°F, wind 8 mph, Out To LF
