...
- **Tier 驗證**：腳本 tier_v2 = 🟢 Back-end Starter（xFIP p24, K-BB% p21），gap vs ERA-only = -17.4
...
### Zebby Matthews (AWAY, RHP, 26 ⚡ 巔峰期)
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 4.82 / 5 / <!-- AI --> | 4.75 / 6 / <!-- AI --> |
...
### 額外信號
- 🟠 AWAY single-pitch dependent：主球種使用率 45.9%（≥45.0%）
- 🟠 AWAY TTO3 penalty：OPS Δ +-0.146（TTO1 0.805 → TTO3 0.659），第三輪明顯衰退；K% 從 24.5% 掉到 17.2%（Δ -7.3pp）（career fallback）
- 🔴 HOME chain breaks at #8-9：OPS 落差 0.807
- 🔴 AWAY chain breaks at #8-9：OPS 落差 0.906
...
- 天氣：Sunny, 74°F, wind 7 mph, In From CF
