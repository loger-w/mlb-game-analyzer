...
### Keider Montero (HOME, RHP, 25 ⚡ 巔峰期)
- **Tier 驗證**：腳本 tier_v2 = 🟡 Solid Starter（xFIP p39, K-BB% p61），gap vs ERA-only = -5.8
...
### Parker Messick (AWAY, LHP, 25 ⚡ 巔峰期)
- **Tier 驗證**：腳本 tier_v2 = 🔴 Elite Ace（xFIP p95, K-BB% p95），gap vs ERA-only = +4.6
  - <!-- AI 補：是否同意 score-derived tier？若 |gap| ≥ 15 → 簡述運氣 vs 結構性，不自動下修預測 -->
- **Reverse platoon 信號**：見 dossier `## 🎯 訊號摘要`（若 fired）
  - <!-- AI 補：若 fired，本場對手核心打者手別組成是否放大此風險？ -->
- **對手打線威脅**：<!-- AI 補：基於 dossier 投手對決表 + 上述兩信號 -->
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 3.95 / 8 / <!-- AI --> | 3.96 / 1 / <!-- AI --> |
...
### 額外信號
- 🟠 HOME TTO3 penalty：OPS Δ +0.142（TTO1 0.539 → TTO3 0.681），第三輪明顯衰退
- 🔴 AWAY TTO3 penalty：OPS Δ +0.295（TTO1 0.444 → TTO3 0.739），第三輪明顯衰退
- 🟠 HOME chain breaks at #2-3：OPS 落差 0.236
- 🔴 AWAY chain breaks at #8-9：OPS 落差 0.338
