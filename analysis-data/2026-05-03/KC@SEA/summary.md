...
### Luis Castillo (HOME, RHP, 33 📉 初期退化)
...
### Kris Bubic (AWAY, LHP, 28 ⚡ 巔峰期)
- **Tier 驗證**：腳本 tier_v2 = 🟡 Solid Starter（xFIP p77, K-BB% p68, velo p5），gap vs ERA-only = +10.2
  - <!-- AI 補：是否同意 score-derived tier？若 |gap| ≥ 15 → 簡述運氣 vs 結構性，不自動下修預測 -->
- **Reverse platoon 信號**：見 dossier `## 🎯 訊號摘要`（若 fired）
  - <!-- AI 補：若 fired，本場對手核心打者手別組成是否放大此風險？ -->
- **對手打線威脅**：<!-- AI 補：基於 dossier 投手對決表 + 上述兩信號 -->
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 3.21 / 4 / <!-- AI --> | 5.12 / 5 / <!-- AI --> |
...
### 額外信號
- 🔴 HOME chain breaks at #7-8：OPS 落差 0.749
- 🟠 AWAY chain breaks at #2-3：OPS 落差 0.165
...
- 天氣：Sunny, 77°F, wind 7 mph, In From LF
