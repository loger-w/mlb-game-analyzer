...
### Logan Henderson (AWAY, RHP, 24 📈 成長期)
- **Tier 驗證**：腳本 tier_v2 = —（—），gap vs ERA-only = —
  - <!-- AI 補：是否同意 score-derived tier？若 |gap| ≥ 15 → 簡述運氣 vs 結構性，不自動下修預測 -->
- **Reverse platoon 信號**：見 dossier `## 🎯 訊號摘要`（若 fired）
  - <!-- AI 補：若 fired，本場對手核心打者手別組成是否放大此風險？ -->
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 4.74 / 6 / <!-- AI --> | 3.65 / 5 / <!-- AI --> |
...
- ⚠️ HOME 投手 Flag 8 (era_xera_delta=-1.99):
  - <!-- AI 補：是運氣還結構性？是否影響本場判斷？不自動下修預測 -->
- ⚠️ AWAY 投手 Flag 8 (era_xera_delta=+6.10):
  - <!-- AI 補：是運氣還結構性？是否影響本場判斷？不自動下修預測 -->

### 額外信號
- 🟠 AWAY single-pitch dependent：主球種使用率 50.8%（≥45.0%）
- 🔴 HOME chain breaks at #1-2：OPS 落差 0.309
- 🟠 AWAY chain breaks at #8-9：OPS 落差 0.182
...
- 天氣：Sunny, 57°F, wind 14 mph, In From LF
...
| HOME | 1.7 | <!-- AI 補 --> | <!-- AI 補 --> |
| AWAY | 6.6 | <!-- AI 補 --> | <!-- AI 補 --> |
| Total | 8.299999999999999 | <!-- AI 補 --> | <!-- AI 補 --> |
