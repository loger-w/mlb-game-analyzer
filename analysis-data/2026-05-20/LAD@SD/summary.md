...
- **Tier 驗證**：腳本 tier_v2 = 🔴 Elite Ace（xFIP p87, K-BB% p80），gap vs ERA-only = +1.5
...
### Shohei Ohtani (AWAY, RHP, 31 📉 初期退化)
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 3.36 / 6 / <!-- AI --> | 3.11 / 12 / <!-- AI --> |
...
- ⚠️ HOME 投手 Flag 8 (era_xera_delta=-2.11):
  - <!-- AI 補：是運氣還結構性？是否影響本場判斷？不自動下修預測 -->
- ⚠️ AWAY 投手 Flag 8 (era_xera_delta=-1.51):
  - <!-- AI 補：是運氣還結構性？是否影響本場判斷？不自動下修預測 -->
- ⚠️ HOME 打線 Flag 3 (last7 BABIP=0.239):
  - <!-- AI 補：可能回歸或可能持續？是否影響本場判斷？不自動 ±run value -->

### 額外信號
- 🟠 HOME TTO3 penalty：OPS Δ +-0.059（TTO1 0.625 → TTO3 0.566），第三輪明顯衰退；K% 從 27.8% 掉到 20.9%（Δ -6.9pp）
- 🟠 AWAY TTO3 penalty：OPS Δ +0.104（TTO1 0.450 → TTO3 0.554），第三輪明顯衰退；K% 從 39.2% 掉到 31.8%（Δ -7.4pp）
- 🟠 HOME chain breaks at #7-8：OPS 落差 0.289
...
| HOME | 2.2 | <!-- AI 補 --> | <!-- AI 補 --> |
| AWAY | 3.6 | <!-- AI 補 --> | <!-- AI 補 --> |
| Total | 5.800000000000001 | <!-- AI 補 --> | <!-- AI 補 --> |
