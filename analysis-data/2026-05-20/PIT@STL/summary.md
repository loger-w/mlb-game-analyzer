...
### Michael McGreevy (HOME, RHP, 25 ⚡ 巔峰期)
- **Tier 驗證**：腳本 tier_v2 = 🟠 Strong Ace（xFIP p78, K-BB% p67），gap vs ERA-only = -14.8
...
### Carmen Mlodzinski (AWAY, RHP, 27 ⚡ 巔峰期)
- **Tier 驗證**：腳本 tier_v2 = 🔴 Elite Ace（xFIP p95, K-BB% p72），gap vs ERA-only = +37.9
  - <!-- AI 補：是否同意 score-derived tier？若 |gap| ≥ 15 → 簡述運氣 vs 結構性，不自動下修預測 -->
- **Reverse platoon 信號**：見 dossier `## 🎯 訊號摘要`（若 fired）
  - <!-- AI 補：若 fired，本場對手核心打者手別組成是否放大此風險？ -->
- **對手打線威脅**：<!-- AI 補：基於 dossier 投手對決表 + 上述兩信號 -->
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 4.43 / 0 / <!-- AI --> | 4.22 / 2 / <!-- AI --> |
...
- ⚠️ HOME 投手 Flag 8 (era_xera_delta=-3.69):
  - <!-- AI 補：是運氣還結構性？是否影響本場判斷？不自動下修預測 -->

### 額外信號
- ℹ️ HOME balanced 4+ pitches：最高球種僅 24.0%（<25.0%）
- 🟠 AWAY TTO3 penalty：OPS Δ +0.129（TTO1 0.730 → TTO3 0.859），第三輪明顯衰退；K% 從 20.5% 掉到 15.6%（Δ -4.9pp）
- 🟠 HOME chain breaks at #4-5：OPS 落差 0.261
...
| HOME | 3.1 | <!-- AI 補 --> | <!-- AI 補 --> |
| AWAY | 4.2 | <!-- AI 補 --> | <!-- AI 補 --> |
| Total | 7.300000000000001 | <!-- AI 補 --> | <!-- AI 補 --> |
