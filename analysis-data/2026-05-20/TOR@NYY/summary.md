...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 3.54 / 4 / <!-- AI --> | 4.06 / 9 / <!-- AI --> |
...
- ⚠️ AWAY 打線 Flag 3 (last7 BABIP=0.24):
  - <!-- AI 補：可能回歸或可能持續？是否影響本場判斷？不自動 ±run value -->

### 額外信號
- 🟠 HOME TTO3 penalty：OPS Δ +0.141（TTO1 0.438 → TTO3 0.579），第三輪明顯衰退；K% 從 33.3% 掉到 15.2%（Δ -18.1pp）
- 🟠 AWAY single-pitch dependent：主球種使用率 49.2%（≥45.0%）
- 🔴 AWAY TTO3 penalty：OPS Δ +0.304（TTO1 0.632 → TTO3 0.936），第三輪明顯衰退；K% 從 31.3% 掉到 20.0%（Δ -11.3pp）（career fallback）
- 🔴 HOME chain breaks at #5-6：OPS 落差 0.488
