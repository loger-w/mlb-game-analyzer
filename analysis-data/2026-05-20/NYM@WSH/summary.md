...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 4.96 / 7 / <!-- AI --> | 3.36 / 7 / <!-- AI --> |
...
- ⚠️ HOME 投手 Flag 8 (era_xera_delta=-1.62):
  - <!-- AI 補：是運氣還結構性？是否影響本場判斷？不自動下修預測 -->

### 額外信號
- 🟠 HOME TTO3 penalty：OPS Δ +-0.049（TTO1 0.777 → TTO3 0.728），第三輪明顯衰退；K% 從 21.5% 掉到 16.9%（Δ -4.6pp）（career fallback）
- 🟠 HOME chain breaks at #3-4：OPS 落差 0.276
- 🔴 AWAY chain breaks at #6-7：OPS 落差 0.366
