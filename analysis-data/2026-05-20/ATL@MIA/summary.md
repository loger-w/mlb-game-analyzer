...
- **Tier 驗證**：腳本 tier_v2 = 🟠 Strong Ace（xFIP p78, K-BB% p58），gap vs ERA-only = +17.4
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 3.45 / 3 / <!-- AI --> | 3.22 / 6 / <!-- AI --> |
...
### 額外信號
- 🟠 HOME chain breaks at #8-9：OPS 落差 0.156
- 🟠 AWAY chain breaks at #1-2：OPS 落差 0.188
