...
- **Tier 驗證**：腳本 tier_v2 = 🟠 Strong Ace（xFIP p88, K-BB% p72），gap vs ERA-only = -4.6
...
### Yoshinobu Yamamoto (AWAY, RHP, 27 ⚡ 巔峰期)
- **Tier 驗證**：腳本 tier_v2 = 🔴 Elite Ace（xFIP p95, K-BB% p95），gap vs ERA-only = +29.1
  - <!-- AI 補：是否同意 score-derived tier？若 |gap| ≥ 15 → 簡述運氣 vs 結構性，不自動下修預測 -->
- **Reverse platoon 信號**：見 dossier `## 🎯 訊號摘要`（若 fired）
  - <!-- AI 補：若 fired，本場對手核心打者手別組成是否放大此風險？ -->
- **對手打線威脅**：<!-- AI 補：基於 dossier 投手對決表 + 上述兩信號 -->
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 3.42 / 6 / <!-- AI --> | 3.24 / 12 / <!-- AI --> |
...
### 額外信號
- 🟠 HOME reverse platoon Δ +0.157（vs RHB OPS 0.682 > vs LHB OPS 0.525）— RHP 對非預期手別反而吃虧
- 🔴 HOME TTO3 penalty：OPS Δ +0.570（TTO1 0.389 → TTO3 0.959），第三輪明顯衰退；K% 從 29.3% 掉到 15.9%（Δ -13.4pp）
- 🟠 AWAY TTO3 penalty：OPS Δ +0.112（TTO1 0.624 → TTO3 0.736），第三輪明顯衰退；K% 從 28.4% 掉到 20.4%（Δ -8.0pp）
- 🔴 HOME chain breaks at #7-8：OPS 落差 0.336
- 🟠 AWAY chain breaks at #5-6：OPS 落差 0.153
