...
- **Tier 驗證**：腳本 tier_v2 = 🔴 Elite Ace（xFIP p95, K-BB% p89），gap vs ERA-only = +19.1
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 3.31 / 3 / <!-- AI --> | 3.04 / 7 / <!-- AI --> |
...
### 額外信號
- 🔴 HOME TTO3 penalty：OPS Δ +0.273（TTO1 0.582 → TTO3 0.855），第三輪明顯衰退；K% 從 27.2% 掉到 17.1%（Δ -10.1pp）
- 🟠 HOME chain breaks at #3-4：OPS 落差 0.283
- 🔴 AWAY chain breaks at #7-8：OPS 落差 0.712
