...
- **Tier 驗證**：腳本 tier_v2 = 🟠 Strong Ace（xFIP p73, K-BB% p66），gap vs ERA-only = +61.8
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 3.81 / 3 / <!-- AI --> | 5.03 / 5 / <!-- AI --> |
...
- ⚠️ HOME 打線 Flag 3 (last7 BABIP=0.22):
  - <!-- AI 補：可能回歸或可能持續？是否影響本場判斷？不自動 ±run value -->

### 額外信號
- 🔴 HOME reverse platoon Δ +0.323（vs RHB OPS 1.056 > vs LHB OPS 0.733）— RHP 對非預期手別反而吃虧
- 🟠 AWAY TTO3 penalty：OPS Δ +0.004（TTO1 0.659 → TTO3 0.663），第三輪明顯衰退；K% 從 31.2% 掉到 19.5%（Δ -11.7pp）（career fallback）
- 🔴 HOME chain breaks at #8-9：OPS 落差 0.447
- 🔴 AWAY chain breaks at #4-5：OPS 落差 0.305
...
- 天氣：Clear, 91°F, wind 10 mph, Out To LF
