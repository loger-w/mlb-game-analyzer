...
### Jake Irvin (HOME, RHP, 29 ⚡ 巔峰期)
- **Tier 驗證**：腳本 tier_v2 = 🟠 Strong Ace（xFIP p76, K-BB% p67），gap vs ERA-only = +59.9
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 4.78 / 7 / <!-- AI --> | 3.45 / 7 / <!-- AI --> |
...
### 額外信號
- 🟠 HOME reverse platoon Δ +0.121（vs RHB OPS 0.841 > vs LHB OPS 0.720）— RHP 對非預期手別反而吃虧
- 🟠 AWAY single-pitch dependent：主球種使用率 53.8%（≥45.0%）
- 🟠 AWAY TTO3 penalty：OPS Δ +0.115（TTO1 0.767 → TTO3 0.882），第三輪明顯衰退；K% 從 24.2% 掉到 19.5%（Δ -4.7pp）（career fallback）
- 🟠 HOME chain breaks at #1-2：OPS 落差 0.167
- 🔴 AWAY chain breaks at #7-8：OPS 落差 0.556
...
- 天氣：Clear, 92°F, wind 10 mph, Out To CF
