...
- **Tier 驗證**：腳本 tier_v2 = 🔴 Elite Ace（xFIP p75, K-BB% p86），gap vs ERA-only = +24.2
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 3.08 / 4 / <!-- AI --> | 4.58 / 4 / <!-- AI --> |
...
### 額外信號
- 🟠 HOME single-pitch dependent：主球種使用率 49.8%（≥45.0%）
- 🔴 HOME chain breaks at #6-7：OPS 落差 0.472
- 🔴 AWAY chain breaks at #7-8：OPS 落差 0.317
