...
- **Tier 驗證**：腳本 tier_v2 = 🟡 Solid Starter（xFIP p52, K-BB% p33），gap vs ERA-only = +18.6
...
- **Tier 驗證**：腳本 tier_v2 = 🟡 Solid Starter（xFIP p55, K-BB% p75），gap vs ERA-only = -12.8
  - <!-- AI 補：是否同意 score-derived tier？若 |gap| ≥ 15 → 簡述運氣 vs 結構性，不自動下修預測 -->
- **Reverse platoon 信號**：見 dossier `## 🎯 訊號摘要`（若 fired）
  - <!-- AI 補：若 fired，本場對手核心打者手別組成是否放大此風險？ -->
- **對手打線威脅**：<!-- AI 補：基於 dossier 投手對決表 + 上述兩信號 -->
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 4.5 / 6 / <!-- AI --> | 3.45 / 7 / <!-- AI --> |
...
### 額外信號
- 🔴 HOME TTO3 penalty：OPS Δ +0.543（TTO1 0.743 → TTO3 1.286），第三輪明顯衰退；K% 從 13.2% 掉到 7.5%（Δ -5.7pp）
- 🟠 AWAY single-pitch dependent：主球種使用率 47.8%（≥45.0%）
- 🟠 AWAY TTO3 penalty：OPS Δ +0.021（TTO1 0.739 → TTO3 0.760），第三輪明顯衰退；K% 從 28.6% 掉到 15.9%（Δ -12.7pp）
- 🟠 HOME chain breaks at #1-2：OPS 落差 0.296
...
| HOME | 5.3 | <!-- AI 補 --> | <!-- AI 補 --> |
| AWAY | 4.6 | <!-- AI 補 --> | <!-- AI 補 --> |
| Total | 9.899999999999999 | <!-- AI 補 --> | <!-- AI 補 --> |
