...
### Luis Severino (HOME, RHP, 32 📉 初期退化)
- **Tier 驗證**：腳本 tier_v2 = 🟡 Solid Starter（xFIP p49, K-BB% p40），gap vs ERA-only = -5.0
...
### Trevor McDonald (AWAY, RHP, 25 ⚡ 巔峰期)
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 4.52 / 2 / <!-- AI --> | 3.4 / 8 / <!-- AI --> |
...
### 額外信號
- ℹ️ HOME balanced 4+ pitches：最高球種僅 23.9%（<25.0%）
- 🟠 HOME TTO3 penalty：OPS Δ +-0.390（TTO1 0.889 → TTO3 0.499），第三輪明顯衰退；K% 從 22.2% 掉到 14.0%（Δ -8.2pp）
- 🟠 AWAY single-pitch dependent：主球種使用率 54.1%（≥45.0%）
- 🔴 HOME chain breaks at #2-3：OPS 落差 0.344
- 🟠 AWAY chain breaks at #7-8：OPS 落差 0.198
