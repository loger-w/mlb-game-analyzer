...
- **Tier 驗證**：腳本 tier_v2 = 🔴 Elite Ace（xFIP p95, K-BB% p95），gap vs ERA-only = +13.0
...
### Mason Fluharty (AWAY, LHP, 24 📈 成長期)
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 3.94 / 8 / <!-- AI --> | 4.18 / 7 / <!-- AI --> |
...
- ⚠️ AWAY 投手 Flag 8 (era_xera_delta=+3.58):
  - <!-- AI 補：是運氣還結構性？是否影響本場判斷？不自動下修預測 -->
- ⚠️ AWAY 打線 Flag 3 (last7 BABIP=0.222):
  - <!-- AI 補：可能回歸或可能持續？是否影響本場判斷？不自動 ±run value -->

### 額外信號
- 🔴 HOME reverse platoon Δ +0.755（vs RHB OPS 1.107 > vs LHB OPS 0.352）— RHP 對非預期手別反而吃虧
- 🟠 AWAY single-pitch dependent：主球種使用率 52.6%（≥45.0%）
- 🟠 HOME chain breaks at #5-6：OPS 落差 0.210
- 🔴 AWAY chain breaks at #8-9：OPS 落差 0.341
...
- 天氣：Cloudy, 70°F, wind 14 mph, In From CF
