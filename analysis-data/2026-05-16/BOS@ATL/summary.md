...
### Bryce Elder (HOME, RHP, 26 ⚡ 巔峰期)
- **Tier 驗證**：腳本 tier_v2 = 🟠 Strong Ace（xFIP p81, K-BB% p78），gap vs ERA-only = -10.7
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 3.06 / 7 / <!-- AI --> | 3.18 / 6 / <!-- AI --> |
...
### 額外信號
- 🟠 HOME reverse platoon Δ +0.125（vs RHB OPS 0.607 > vs LHB OPS 0.482）— RHP 對非預期手別反而吃虧
- 🟠 HOME TTO3 penalty：OPS Δ +0.001（TTO1 0.447 → TTO3 0.448），第三輪明顯衰退；K% 從 28.4% 掉到 20.4%（Δ -8.0pp）
- 🟠 HOME chain breaks at #6-7：OPS 落差 0.246
- 🟠 AWAY chain breaks at #5-6：OPS 落差 0.284
