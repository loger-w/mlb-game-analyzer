...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 3.5 / 6 / <!-- AI --> | 3.35 / 3 / <!-- AI --> |
...
- ⚠️ AWAY 投手 Flag 8 (era_xera_delta=+1.73):
  - <!-- AI 補：是運氣還結構性？是否影響本場判斷？不自動下修預測 -->
- ⚠️ HOME 打線 Flag 3 (last7 BABIP=0.244):
  - <!-- AI 補：可能回歸或可能持續？是否影響本場判斷？不自動 ±run value -->

### 額外信號
- 🟠 HOME single-pitch dependent：主球種使用率 47.5%（≥45.0%）
- 🟠 AWAY TTO3 penalty：OPS Δ +0.032（TTO1 0.677 → TTO3 0.709），第三輪明顯衰退；K% 從 28.6% 掉到 25.4%（Δ -3.2pp）（career fallback）
- 🔴 HOME chain breaks at #6-7：OPS 落差 0.369
- 🔴 AWAY chain breaks at #5-6：OPS 落差 0.545
