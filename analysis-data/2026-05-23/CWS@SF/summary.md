...
- **Tier 驗證**：腳本 tier_v2 = 🟢 Back-end Starter（xFIP p27, K-BB% p10），gap vs ERA-only = +2.1
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 3.42 / 7 / <!-- AI --> | 4.56 / 4 / <!-- AI --> |
...
### 額外信號
- 🟠 HOME single-pitch dependent：主球種使用率 46.9%（≥45.0%）
- 🟠 HOME TTO3 penalty：OPS Δ +-0.006（TTO1 0.877 → TTO3 0.871），第三輪明顯衰退；K% 從 21.1% 掉到 0.0%（Δ -21.1pp）
- 🔴 AWAY reverse platoon Δ +0.228（vs LHB OPS 0.766 > vs RHB OPS 0.538）— LHP 對非預期手別反而吃虧
- 🟠 AWAY single-pitch dependent：主球種使用率 62.9%（≥45.0%）
- 🔴 HOME chain breaks at #8-9：OPS 落差 0.510
- 🔴 AWAY chain breaks at #7-8：OPS 落差 0.340
