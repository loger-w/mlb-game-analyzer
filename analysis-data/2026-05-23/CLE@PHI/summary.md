...
- **Tier 驗證**：腳本 tier_v2 = 🟡 Solid Starter（xFIP p60, K-BB% p50），gap vs ERA-only = +33.3
  - <!-- AI 補：是否同意 score-derived tier？若 |gap| ≥ 15 → 簡述運氣 vs 結構性，不自動下修預測 -->
- **Reverse platoon 信號**：見 dossier `## 🎯 訊號摘要`（若 fired）
  - <!-- AI 補：若 fired，本場對手核心打者手別組成是否放大此風險？ -->
- **對手打線威脅**：<!-- AI 補：基於 dossier 投手對決表 + 上述兩信號 -->
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 4.07 / 3 / <!-- AI --> | 3.78 / 0 / <!-- AI --> |
...
### 額外信號
- 🟠 HOME reverse platoon Δ +0.099（vs RHB OPS 0.569 > vs LHB OPS 0.470）— RHP 對非預期手別反而吃虧
- 🔴 HOME TTO3 penalty：OPS Δ +0.225（TTO1 0.442 → TTO3 0.667），第三輪明顯衰退
- 🟠 AWAY reverse platoon Δ +0.175（vs RHB OPS 0.908 > vs LHB OPS 0.733）— RHP 對非預期手別反而吃虧
- 🔴 AWAY TTO3 penalty：OPS Δ +0.539（TTO1 0.676 → TTO3 1.215），第三輪明顯衰退；K% 從 17.0% 掉到 12.0%（Δ -5.0pp）
- 🟠 HOME chain breaks at #3-4：OPS 落差 0.288
- 🟠 AWAY chain breaks at #8-9：OPS 落差 0.284
