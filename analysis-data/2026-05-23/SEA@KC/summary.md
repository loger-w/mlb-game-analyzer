...
- **Tier 驗證**：腳本 tier_v2 = 🔴 Elite Ace（xFIP p95, K-BB% p75），gap vs ERA-only = +18.2
  - <!-- AI 補：是否同意 score-derived tier？若 |gap| ≥ 15 → 簡述運氣 vs 結構性，不自動下修預測 -->
- **Reverse platoon 信號**：見 dossier `## 🎯 訊號摘要`（若 fired）
  - <!-- AI 補：若 fired，本場對手核心打者手別組成是否放大此風險？ -->
- **對手打線威脅**：<!-- AI 補：基於 dossier 投手對決表 + 上述兩信號 -->
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 4.53 / 6 / <!-- AI --> | 3.04 / 3 / <!-- AI --> |
...
- ⚠️ AWAY 打線 Flag 3 (last7 BABIP=0.216):
  - <!-- AI 補：可能回歸或可能持續？是否影響本場判斷？不自動 ±run value -->

### 額外信號
- 🟠 HOME TTO3 penalty：OPS Δ +0.022（TTO1 0.680 → TTO3 0.702），第三輪明顯衰退；K% 從 18.7% 掉到 13.8%（Δ -4.9pp）（career fallback）
- 🟠 AWAY TTO3 penalty：OPS Δ +0.135（TTO1 0.586 → TTO3 0.721），第三輪明顯衰退
- 🟠 HOME chain breaks at #2-3：OPS 落差 0.227
- 🔴 AWAY chain breaks at #7-8：OPS 落差 0.410
...
- 天氣：Partly Cloudy, 77°F, wind 6 mph, In From LF
...
| HOME | 3.8 | <!-- AI 補 --> | <!-- AI 補 --> |
| AWAY | 5.6 | <!-- AI 補 --> | <!-- AI 補 --> |
| Total | 9.399999999999999 | <!-- AI 補 --> | <!-- AI 補 --> |
