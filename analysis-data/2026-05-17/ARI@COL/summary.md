...
### Michael Lorenzen (HOME, RHP, 34 📉📉 明顯退化)
- **Tier 驗證**：腳本 tier_v2 = 🟡 Solid Starter（xFIP p69, K-BB% p36），gap vs ERA-only = +42.8
...
### Michael Soroka (AWAY, RHP, 28 ⚡ 巔峰期)
- **Tier 驗證**：腳本 tier_v2 = 🔴 Elite Ace（xFIP p95, K-BB% p95），gap vs ERA-only = +26.8
  - <!-- AI 補：是否同意 score-derived tier？若 |gap| ≥ 15 → 簡述運氣 vs 結構性，不自動下修預測 -->
- **Reverse platoon 信號**：見 dossier `## 🎯 訊號摘要`（若 fired）
  - <!-- AI 補：若 fired，本場對手核心打者手別組成是否放大此風險？ -->
- **對手打線威脅**：<!-- AI 補：基於 dossier 投手對決表 + 上述兩信號 -->
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 4.26 / 6 / <!-- AI --> | 4.36 / 6 / <!-- AI --> |
...
### 額外信號
- ℹ️ HOME balanced 4+ pitches：最高球種僅 20.6%（<25.0%）
- 🔴 HOME TTO3 penalty：OPS Δ +0.164（TTO1 1.018 → TTO3 1.182），第三輪明顯衰退；K% 從 18.1% 掉到 12.5%（Δ -5.6pp）
- 🟠 HOME platoon advantage：top 5 中 4 人對 RHP OPS 較 season +0.050 以上
- 🟠 HOME chain breaks at #5-6：OPS 落差 0.209
- 🟠 AWAY chain breaks at #4-5：OPS 落差 0.242
...
- 天氣：Cloudy, 68°F, wind 9 mph, In From RF
