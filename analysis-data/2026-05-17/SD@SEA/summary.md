...
### George Kirby (HOME, RHP, 28 ⚡ 巔峰期)
- **Tier 驗證**：腳本 tier_v2 = 🔴 Elite Ace（xFIP p95, K-BB% p74），gap vs ERA-only = +5.2
...
### Lucas Giolito (AWAY, RHP, 31 📉 初期退化)
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 3.03 / 4 / <!-- AI --> | 3.49 / 6 / <!-- AI --> |
...
### 額外信號
- 🟠 HOME reverse platoon Δ +0.199（vs RHB OPS 0.728 > vs LHB OPS 0.529）— RHP 對非預期手別反而吃虧
- 🟠 AWAY TTO3 penalty：OPS Δ +-0.105（TTO1 0.816 → TTO3 0.711），第三輪明顯衰退；K% 從 27.0% 掉到 20.5%（Δ -6.5pp）（career fallback）
- 🔴 HOME chain breaks at #6-7：OPS 落差 0.474
- 🟠 AWAY chain breaks at #7-8：OPS 落差 0.200
