...
- **Tier 驗證**：腳本 tier_v2 = 🟠 Strong Ace（xFIP p82, K-BB% p77），gap vs ERA-only = +5.4
...
### Elmer Rodríguez (AWAY, RHP, 22 📈 成長期)
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 3.45 / 7 / <!-- AI --> | 3.43 / 4 / <!-- AI --> |
...
- ⚠️ AWAY 投手 Flag 8 (era_xera_delta=-2.29):
...
### 額外信號
- 🟠 HOME single-pitch dependent：主球種使用率 55.8%（≥45.0%）
- 🟠 HOME TTO3 penalty：OPS Δ +-0.092（TTO1 0.657 → TTO3 0.565），第三輪明顯衰退；K% 從 28.4% 掉到 22.9%（Δ -5.5pp）
- 🔴 HOME chain breaks at #8-9：OPS 落差 0.963
- 🟠 AWAY chain breaks at #3-4：OPS 落差 0.197
...
- 天氣：Sunny, 83°F, wind 9 mph, Out To CF
