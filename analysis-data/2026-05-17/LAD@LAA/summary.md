...
### Roki Sasaki (AWAY, RHP, 24 📈 成長期)
- **Tier 驗證**：腳本 tier_v2 = 🟡 Solid Starter（xFIP p48, K-BB% p46），gap vs ERA-only = +41.3
  - <!-- AI 補：是否同意 score-derived tier？若 |gap| ≥ 15 → 簡述運氣 vs 結構性，不自動下修預測 -->
- **Reverse platoon 信號**：見 dossier `## 🎯 訊號摘要`（若 fired）
  - <!-- AI 補：若 fired，本場對手核心打者手別組成是否放大此風險？ -->
- **對手打線威脅**：<!-- AI 補：基於 dossier 投手對決表 + 上述兩信號 -->
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 5.48 / 4 / <!-- AI --> | 3.28 / 11 / <!-- AI --> |
...
### 額外信號
- 🟠 AWAY TTO3 penalty：OPS Δ +0.018（TTO1 0.697 → TTO3 0.715），第三輪明顯衰退；K% 從 22.2% 掉到 16.1%（Δ -6.1pp）
- 🟠 HOME chain breaks at #2-3：OPS 落差 0.215
- 🟠 AWAY chain breaks at #7-8：OPS 落差 0.242
...
- 天氣：Partly Cloudy, 72°F, wind 9 mph, Out To LF
