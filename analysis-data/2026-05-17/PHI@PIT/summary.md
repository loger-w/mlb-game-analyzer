...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 4.14 / 2 / <!-- AI --> | 3.85 / 3 / <!-- AI --> |
...
### 額外信號
- 🟠 HOME TTO3 penalty：OPS Δ +0.022（TTO1 0.507 → TTO3 0.529），第三輪明顯衰退；K% 從 36.7% 掉到 26.5%（Δ -10.2pp）
- 🟠 AWAY reverse platoon Δ +0.128（vs RHB OPS 0.614 > vs LHB OPS 0.486）— RHP 對非預期手別反而吃虧
- 🟠 AWAY TTO3 penalty：OPS Δ +0.145（TTO1 0.551 → TTO3 0.696），第三輪明顯衰退；K% 從 29.9% 掉到 26.0%（Δ -3.9pp）（career fallback）
- 🔴 AWAY chain breaks at #3-4：OPS 落差 0.375
  - <!-- AI 補：本場是否受此信號影響？是否與 Flag 3/8 雙重壓力 → 1-2 句敘事 -->

## 條件修正

- Park Factor: 102.0 → +0.10 run
- 天氣：Partly Cloudy, 79°F, wind 10 mph, Out To LF
