...
- **Tier 驗證**：腳本 tier_v2 = 🟡 Solid Starter（xFIP p64, K-BB% p32），gap vs ERA-only = +11.8
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 4.53 / 0 / <!-- AI --> | 4.5 / 5 / <!-- AI --> |
...
### 額外信號
- 🟠 AWAY TTO3 penalty：OPS Δ +0.038（TTO1 0.685 → TTO3 0.723），第三輪明顯衰退；K% 從 18.7% 掉到 13.7%（Δ -5.0pp）（career fallback）
- 🔴 HOME chain breaks at #7-8：OPS 落差 0.308
- 🟠 AWAY chain breaks at #2-3：OPS 落差 0.259
...
- 天氣：Partly Cloudy, 80°F, wind 17 mph, Out To LF
