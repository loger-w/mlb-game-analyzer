...
- **Tier 驗證**：腳本 tier_v2 = 🟡 Solid Starter（xFIP p44, K-BB% p58），gap vs ERA-only = -11.0
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 5.23 / 7 / <!-- AI --> | 3.34 / 5 / <!-- AI --> |
...
### 額外信號
- 🔴 HOME TTO3 penalty：OPS Δ +0.436（TTO1 0.395 → TTO3 0.831），第三輪明顯衰退
- 🟠 AWAY TTO3 penalty：OPS Δ +0.139（TTO1 0.816 → TTO3 0.955），第三輪明顯衰退；K% 從 23.0% 掉到 6.2%（Δ -16.8pp）（career fallback）
- 🔴 HOME chain breaks at #8-9：OPS 落差 0.626
- 🟠 AWAY platoon advantage：top 5 中 4 人對 RHP OPS 較 season +0.050 以上
- 🟠 AWAY chain breaks at #5-6：OPS 落差 0.230
...
- 天氣：Partly Cloudy, 63°F, wind 15 mph, In From CF
