...
### Shota Imanaga (AWAY, LHP, 32 📉 初期退化)
- **Tier 驗證**：腳本 tier_v2 = 🔴 Elite Ace（xFIP p95, K-BB% p95），gap vs ERA-only = -0.4
  - <!-- AI 補：是否同意 score-derived tier？若 |gap| ≥ 15 → 簡述運氣 vs 結構性，不自動下修預測 -->
- **Reverse platoon 信號**：見 dossier `## 🎯 訊號摘要`（若 fired）
  - <!-- AI 補：若 fired，本場對手核心打者手別組成是否放大此風險？ -->
- **對手打線威脅**：<!-- AI 補：基於 dossier 投手對決表 + 上述兩信號 -->
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 3.2 / 7 / <!-- AI --> | 3.77 / 9 / <!-- AI --> |
...
### 額外信號
- 🔴 AWAY TTO3 penalty：OPS Δ +0.320（TTO1 0.602 → TTO3 0.922），第三輪明顯衰退；K% 從 29.3% 掉到 10.9%（Δ -18.4pp）
- 🟠 HOME chain breaks at #6-7：OPS 落差 0.279
- 🟠 AWAY chain breaks at #7-8：OPS 落差 0.157
