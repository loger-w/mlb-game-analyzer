...
- **Tier 驗證**：腳本 tier_v2 = 🔴 Elite Ace（xFIP p95, K-BB% p95），gap vs ERA-only = +5.2
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 4.22 / 7 / <!-- AI --> | 4.07 / 7 / <!-- AI --> |
...
### 額外信號
- 🔴 HOME TTO3 penalty：OPS Δ +0.371（TTO1 0.446 → TTO3 0.817），第三輪明顯衰退；K% 從 39.5% 掉到 22.9%（Δ -16.6pp）
