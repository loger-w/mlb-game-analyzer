...
- **Tier 驗證**：腳本 tier_v2 = 🟠 Strong Ace（xFIP p85, K-BB% p75），gap vs ERA-only = +52.5
  - <!-- AI 補：是否同意 score-derived tier？若 |gap| ≥ 15 → 簡述運氣 vs 結構性，不自動下修預測 -->
- **Reverse platoon 信號**：見 dossier `## 🎯 訊號摘要`（若 fired）
  - <!-- AI 補：若 fired，本場對手核心打者手別組成是否放大此風險？ -->
- **對手打線威脅**：<!-- AI 補：基於 dossier 投手對決表 + 上述兩信號 -->
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 4.7 / 4 / <!-- AI --> | 4.79 / 7 / <!-- AI --> |
...
- ⚠️ HOME 投手 Flag 8 (era_xera_delta=-6.30):
  - <!-- AI 補：是運氣還結構性？是否影響本場判斷？不自動下修預測 -->

### 額外信號
- 🟠 HOME TTO3 penalty：OPS Δ +0.012（TTO1 0.649 → TTO3 0.661），第三輪明顯衰退；K% 從 31.2% 掉到 19.5%（Δ -11.7pp）（career fallback）
- 🟠 HOME chain breaks at #2-3：OPS 落差 0.211
- 🟠 AWAY chain breaks at #3-4：OPS 落差 0.229
