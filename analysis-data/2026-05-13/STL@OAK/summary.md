...
- **Tier 驗證**：腳本 tier_v2 = 🟠 Strong Ace（xFIP p74, K-BB% p54），gap vs ERA-only = +6.0
...
- **Tier 驗證**：腳本 tier_v2 = 🟢 Back-end Starter（xFIP p29, K-BB% p30），gap vs ERA-only = -12.5
  - <!-- AI 補：是否同意 score-derived tier？若 |gap| ≥ 15 → 簡述運氣 vs 結構性，不自動下修預測 -->
- **Reverse platoon 信號**：見 dossier `## 🎯 訊號摘要`（若 fired）
  - <!-- AI 補：若 fired，本場對手核心打者手別組成是否放大此風險？ -->
- **對手打線威脅**：<!-- AI 補：基於 dossier 投手對決表 + 上述兩信號 -->
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 4.67 / 1 / <!-- AI --> | 4.59 / 1 / <!-- AI --> |
...
### 額外信號
- 🟠 HOME TTO3 penalty：OPS Δ +-0.051（TTO1 0.820 → TTO3 0.769），第三輪明顯衰退；K% 從 25.5% 掉到 15.6%（Δ -9.9pp）（career fallback）
- 🔴 AWAY reverse platoon Δ +0.320（vs LHB OPS 1.036 > vs RHB OPS 0.716）— LHP 對非預期手別反而吃虧
- 🔴 AWAY TTO3 penalty：OPS Δ +0.498（TTO1 0.684 → TTO3 1.182），第三輪明顯衰退；K% 從 25.9% 掉到 2.8%（Δ -23.1pp）
- 🔴 HOME chain breaks at #2-3：OPS 落差 0.355
...
| HOME | 6.6 | <!-- AI 補 --> | <!-- AI 補 --> |
| AWAY | 5.3 | <!-- AI 補 --> | <!-- AI 補 --> |
| Total | 11.899999999999999 | <!-- AI 補 --> | <!-- AI 補 --> |
