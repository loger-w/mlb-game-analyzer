...
| | HOME | AWAY |
|---|---|---|
| ERA / IL 數 / 核心 IL 估計 | 3.95 / ? / <!-- AI --> | 5.21 / ? / <!-- AI --> |
...
- ⚠️ HOME 投手 Flag 13 (era_xera_delta=-1.63):
  - <!-- AI 補：是運氣還結構性？是否影響本場判斷？不自動下修預測 -->
- ⚠️ AWAY 投手 Flag 13 (era_xera_delta=-5.51):
  - <!-- AI 補：是運氣還結構性？是否影響本場判斷？不自動下修預測 -->
