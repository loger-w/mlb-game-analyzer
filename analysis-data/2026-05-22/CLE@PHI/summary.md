...
### Gavin Williams (AWAY, RHP, 26 ⚡ 巔峰期)
- **Tier 驗證**：腳本 tier_v2 = 🔴 Elite Ace（xFIP p95, K-BB% p95），gap vs ERA-only = +30.5
  - <!-- AI 補：是否同意 score-derived tier？若 |gap| ≥ 15 → 簡述運氣 vs 結構性，不自動下修預測 -->
- **Reverse platoon 信號**：見 dossier `## 🎯 訊號摘要`（若 fired）
  - <!-- AI 補：若 fired，本場對手核心打者手別組成是否放大此風險？ -->
- **對手打線威脅**：<!-- AI 補：基於 dossier 投手對決表 + 上述兩信號 -->
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 4.04 / 3 / <!-- AI --> | 3.8 / 0 / <!-- AI --> |
...
### 額外信號
- 🟠 AWAY TTO3 penalty：OPS Δ +-0.204（TTO1 0.773 → TTO3 0.569），第三輪明顯衰退；K% 從 30.0% 掉到 25.0%（Δ -5.0pp）
- 🟠 HOME chain breaks at #3-4：OPS 落差 0.281
- 🟠 AWAY chain breaks at #8-9：OPS 落差 0.290
