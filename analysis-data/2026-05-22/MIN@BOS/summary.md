...
- **Tier 驗證**：腳本 tier_v2 = 🔴 Elite Ace（xFIP p84, K-BB% p95），gap vs ERA-only = -2.9
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 2.98 / 6 / <!-- AI --> | 5.0 / 7 / <!-- AI --> |
...
### 額外信號
- 🔴 HOME reverse platoon Δ +0.314（vs LHB OPS 0.725 > vs RHB OPS 0.411）— LHP 對非預期手別反而吃虧
- 🔴 HOME chain breaks at #4-5：OPS 落差 0.300
- 🟠 AWAY chain breaks at #2-3：OPS 落差 0.237
