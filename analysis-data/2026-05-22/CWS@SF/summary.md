...
### Trevor McDonald (HOME, RHP, 25 ⚡ 巔峰期)
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 3.48 / 7 / <!-- AI --> | 4.63 / 4 / <!-- AI --> |
...
- ⚠️ AWAY 投手 Flag 8 (era_xera_delta=-2.06):
  - <!-- AI 補：是運氣還結構性？是否影響本場判斷？不自動下修預測 -->

### 額外信號
- 🟠 HOME single-pitch dependent：主球種使用率 56.5%（≥45.0%）
- 🟠 AWAY reverse platoon Δ +0.099（vs RHB OPS 0.664 > vs LHB OPS 0.565）— RHP 對非預期手別反而吃虧
- 🔴 AWAY TTO3 penalty：OPS Δ +0.323（TTO1 0.418 → TTO3 0.741），第三輪明顯衰退；K% 從 30.9% 掉到 18.9%（Δ -12.0pp）
- 🟠 HOME chain breaks at #6-7：OPS 落差 0.269
...
| HOME | 2.1 | <!-- AI 補 --> | <!-- AI 補 --> |
| AWAY | 3.2 | <!-- AI 補 --> | <!-- AI 補 --> |
| Total | 5.300000000000001 | <!-- AI 補 --> | <!-- AI 補 --> |
