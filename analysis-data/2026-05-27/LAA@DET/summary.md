...
- **Tier 驗證**：腳本 tier_v2 = 🔴 Elite Ace（xFIP p95, K-BB% p87），gap vs ERA-only = +2.7
  - <!-- AI 補：是否同意 score-derived tier？若 |gap| ≥ 15 → 簡述運氣 vs 結構性，不自動下修預測 -->
- **Reverse platoon 信號**：見 dossier `## 🎯 訊號摘要`（若 fired）
  - <!-- AI 補：若 fired，本場對手核心打者手別組成是否放大此風險？ -->
- **對手打線威脅**：<!-- AI 補：基於 dossier 投手對決表 + 上述兩信號 -->
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 4.11 / 9 / <!-- AI --> | 5.32 / 4 / <!-- AI --> |
...
### 額外信號
- 🔴 HOME reverse platoon Δ +0.486（vs RHB OPS 0.890 > vs LHB OPS 0.404）— RHP 對非預期手別反而吃虧
- 🔴 AWAY TTO3 penalty：OPS Δ +0.232（TTO1 0.449 → TTO3 0.681），第三輪明顯衰退；K% 從 33.0% 掉到 25.0%（Δ -8.0pp）
- 🟠 HOME chain breaks at #2-3：OPS 落差 0.166
- 🟠 AWAY chain breaks at #6-7：OPS 落差 0.240
