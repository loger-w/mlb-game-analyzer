...
- **Tier 驗證**：腳本 tier_v2 = 🟠 Strong Ace（xFIP p72, K-BB% p58），gap vs ERA-only = +36.0
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 3.08 / 6 / <!-- AI --> | 3.92 / 3 / <!-- AI --> |
...
- ⚠️ HOME 打線 Flag 3 (last7 BABIP=0.163):
  - <!-- AI 補：可能回歸或可能持續？是否影響本場判斷？不自動 ±run value -->
- ⚠️ AWAY 打線 Flag 3 (last7 BABIP=0.252):
  - <!-- AI 補：可能回歸或可能持續？是否影響本場判斷？不自動 ±run value -->

### 額外信號
- ℹ️ HOME balanced 4+ pitches：最高球種僅 22.9%（<25.0%）
- 🟠 HOME chain breaks at #7-8：OPS 落差 0.220
- 🟠 AWAY chain breaks at #3-4：OPS 落差 0.292
...
| HOME | 1.9 | <!-- AI 補 --> | <!-- AI 補 --> |
| AWAY | 3.8 | <!-- AI 補 --> | <!-- AI 補 --> |
| Total | 5.699999999999999 | <!-- AI 補 --> | <!-- AI 補 --> |
