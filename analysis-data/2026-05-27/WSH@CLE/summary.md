...
- **Tier 驗證**：腳本 tier_v2 = 🔴 Elite Ace（xFIP p95, K-BB% p95），gap vs ERA-only = +22.1
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 3.58 / 1 / <!-- AI --> | 4.69 / 7 / <!-- AI --> |
...
- ⚠️ AWAY 投手 Flag 8 (era_xera_delta=-2.41):
  - <!-- AI 補：是運氣還結構性？是否影響本場判斷？不自動下修預測 -->
- ⚠️ HOME 打線 Flag 3 (last7 BABIP=0.246):
  - <!-- AI 補：可能回歸或可能持續？是否影響本場判斷？不自動 ±run value -->
- ⚠️ AWAY 打線 Flag 3 (last7 BABIP=0.257):
  - <!-- AI 補：可能回歸或可能持續？是否影響本場判斷？不自動 ±run value -->

### 額外信號
- 🟠 HOME TTO3 penalty：OPS Δ +-0.200（TTO1 0.754 → TTO3 0.554），第三輪明顯衰退；K% 從 31.2% 掉到 26.0%（Δ -5.2pp）
- 🟠 AWAY platoon advantage：top 5 中 4 人對 RHP OPS 較 season +0.050 以上
- 🟠 AWAY chain breaks at #1-2：OPS 落差 0.245
...
- 天氣：Partly Cloudy, 70°F, wind 5 mph, In From CF
