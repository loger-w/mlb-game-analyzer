...
### Huascar Brazobán (HOME, RHP, 36 📉📉 明顯退化)
...
- **Tier 驗證**：腳本 tier_v2 = 🟢 Back-end Starter（xFIP p16, K-BB% p18），gap vs ERA-only = -24.8
  - <!-- AI 補：是否同意 score-derived tier？若 |gap| ≥ 15 → 簡述運氣 vs 結構性，不自動下修預測 -->
- **Reverse platoon 信號**：見 dossier `## 🎯 訊號摘要`（若 fired）
  - <!-- AI 補：若 fired，本場對手核心打者手別組成是否放大此風險？ -->
- **對手打線威脅**：<!-- AI 補：基於 dossier 投手對決表 + 上述兩信號 -->
...
| | HOME | AWAY |
|---|---|---|
| ERA / 投手 IL / 核心 IL 估計 | 3.35 / 6 / <!-- AI --> | 4.92 / 4 / <!-- AI --> |
...
### 額外信號
- 🟠 HOME single-pitch dependent：主球種使用率 50.1%（≥45.0%）
- 🟠 AWAY single-pitch dependent：主球種使用率 47.5%（≥45.0%）
- 🟠 HOME platoon advantage：top 5 中 4 人對 LHP OPS 較 season +0.050 以上
- 🔴 HOME chain breaks at #6-7：OPS 落差 0.408
- 🟠 AWAY chain breaks at #4-5：OPS 落差 0.263
