"""Tests for phase3_summary_renderer."""
import os
import sys
...
def test_skeleton_risk_section_lists_triggers_when_present():
    ...
    bundle["away_pitcher"]["expected"] = {"xera": 4.64}  # gap = 2.54 → Flag 8
...
def test_skeleton_line_count_within_60():
    """phase3_summary.md template line count ≤ 60 (含 flag 觸發)"""
    from phase3_summary_renderer import render_summary
    output = render_summary(_minimal_bundle(), _minimal_formula_pred())
